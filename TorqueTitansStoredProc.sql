--------------------------------------------------------
--  File created - Saturday-April-12-2025   
--------------------------------------------------------
--------------------------------------------------------
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "N01680074"."MANAGECUSTOMER" (
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "N01680074"."MANAGECUSTOMERS" (
...
/
  ...
  GRANT EXECUTE ON "N01680074"."MANAGECUSTOMERS" TO PUBLIC;
--------------------------------------------------------
--  DDL for Procedure MANAGEMECHANIC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "N01680074"."MANAGEMECHANIC" (
    Action IN VARCHAR2,
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "N01680074"."MANAGEMECHANICS" (
    p_action IN VARCHAR2,
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "N01680074"."MANAGESERVICERECORD" (
    p_Operation IN VARCHAR2,
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "N01680074"."MANAGEVEHICLES" (
    p_action IN VARCHAR2,
